...
export default class controlPanel extends Component {
  ...
  * */
  ...
  render() {
    let { controlPanel } = this.props;
    return (
      <GridContent>
        <div className={style.add}>{controlPanel.text}</div>
